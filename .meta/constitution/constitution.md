...
| 槽位 | 应填内容 |
|---|---|
| 项目名 | pproxy (Pony Proxy) |
| 一句话定位 | 自托管开发者出海代理与智能 API 网关（Rust 多 crate 工作区 + Tauri 桌面端） |
| 技术栈 | Rust (Tokio, Axum, Tower), TypeScript / Tauri (Desktop), Cloudflare Workers, Vercel |
| 成熟度目标 | L2 |
