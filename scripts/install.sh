...
ExecStart=${INSTALL_DIR}/pproxy serve --listen 0.0.0.0:8899 --admin-listen 0.0.0.0:8900
Restart=always
RestartSec=3
LimitNOFILE=65535
...
ExecStart=${INSTALL_DIR}/pproxy serve --listen 127.0.0.1:8899 --admin-listen 127.0.0.1:8900
Restart=always
RestartSec=3
LimitNOFILE=65535
NoNewPrivileges=true
